...
echo 'warp_price_per_kg: ' . $warp_price_per_kg . '<br>';
    ...
    elseif ($yarn_type == 'warp') {
    ...
    } elseif ($yarn_type == 'both') {
        echo "Inserting Both data";
        // Insert both warp and weft data
        $sql = "INSERT INTO yarn_purchase_order 
            (sales_order_no, yarn_purchase_order_no, warp_count, warp_composition, warp_qty, warp_yarn_mill, warp_delivery_schedule, warp_price_per_kg, warp_invoice_address, warp_delivery_address, warp_price_basis, warp_payment_terms,
            weft_count, weft_composition, weft_qty, weft_yarn_mill, weft_delivery_schedule, weft_price_per_kg, weft_invoice_address, weft_delivery_address, weft_price_basis, weft_payment_terms) 
            VALUES 
            (:sales_order_no, :yarn_purchase_order_no, :warp_count, :warp_composition, :warp_qty, :warp_yarn_mill, :warp_delivery_schedule, :warp_price_per_kg, :warp_invoice_address, :warp_delivery_address, :warp_price_basis, :warp_payment_terms,
            :weft_count, :weft_composition, :weft_qty, :weft_yarn_mill, :weft_delivery_schedule, :weft_price_per_kg, :weft_invoice_address, :weft_delivery_address, :weft_price_basis, :weft_payment_terms)";
        ...
        // Bind values for both warp and weft data
        $stmt->bindValue(':sales_order_no', $sales_order_no);
        $stmt->bindValue(':yarn_purchase_order_no', $yarn_purchase_order_no);
        // Bind warp data
        $stmt->bindValue(':warp_count', $warp_count);
        ...
        if ($stmt->execute()) {
            echo "<p>Both Warp and Weft Data Successfully Inserted!</p>";
        } else {
            echo "<p>Error: " . implode(", ", $stmt->errorInfo()) . "</p>";
        }
    }
...
<head>
    ...
    function showSection(type) {
        ...
        if (type === 'warp') {
            ...
            document.getElementById('both-section').style.display = 'block';
        }
    }
</script>
</head>
<body>
    <div class="container">
        ...
        <div class="form-row1 order-type1">
            ...
            <label>
                <input type="radio" name="yarn_type" value="both" onclick="showSection('both')"> Both
            </label>
        </div>
    ...
    <div id="weft-section" class="form-section">
        ...
        <div id="both-section" class="form-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="warp_payment_terms">Warp Payment Terms:</label>
                    <input type="text" id="warp_payment_terms" name="warp_payment_terms" >
                </div>
                <div class="form-group">
                    <label for="warp_price_basis">Warp Price Basis:</label>
                    <input type="text" id="warp_price_basis" name="warp_price_basis" >
                </div>
                <div class="form-group">
                    <label for="warp_yarn_mill">Warp Yarn Mill:</label>
                    <input type="text" id="warp_yarn_mill" name="warp_yarn_mill" >
                </div>
            </div>
         <!-- Row 3 -->
            <div class="form-row">
                <div class="form-group">
                    <label for="warp_price_per_kg">Warp Price/Kg:</label>
                    <input type="number" step="0.01" id="warp_price_per_kg" name="warp_price_per_kg" >
                </div>
                <div class="form-group">
                    <label for="warp_delivery_schedule">Warp Delivery Schedule:</label>
                    <input type="text" id="warp_delivery_schedule" name="warp_delivery_schedule" >
                </div>
                <div class="form-group">
                    <label for="warp_invoice_address">Warp Invoice Address:</label>
                    <input type="text" id="warp_invoice_address" name="warp_invoice_address" >
                </div>
                <div class="form-group">
                    <label for="warp_delivery_address">Warp Delivery Address:</label>
                    <input type="text" id="warp_delivery_address" name="warp_delivery_address" >
                </div>
        ...
        <!-- Row 4 -->
         <!-- Weft Inputs -->
            <div class="form-row">
                <!-- <div class="form-group">
                    <label for="sales_order_no">Weft Sales Order No:</label>
                    <input type="text" id="sales_order_no" name="sales_order_no" >
                </div>
                <div class="form-group">
                    <label for="yarn_purchase_order_no">Weft Yarn Purchase Order No:</label>
                    <input type="text" id="yarn_purchase_order_no" name="yarn_purchase_order_no" >
                </div> -->
                <div class="form-group">
                    <label for="weft_count">Weft Count:</label>
                    <input type="number" id="weft_count" name="weft_count" >
                ...
                <div class="form-group">
                    <label for="weft_payment_terms">Weft Payment Terms:</label>
                    <input type="text" id="weft_payment_terms" name="weft_payment_terms" >
                </div>
            </div>
        <!-- Row 5 -->
            <div class="form-row">
                <div class="form-group">
                    <label for="weft_price_basis">Weft Price Basis:</label>
                    <input type="text" id="weft_price_basis" name="weft_price_basis" >
                </div>
                <div class="form-group">
                    <label for="weft_yarn_mill">Weft Yarn Mill:</label>
                    <input type="text" id="weft_yarn_mill" name="weft_yarn_mill" >
                </div>
                <div class="form-group">
                    <label for="weft_price_per_kg">Weft Price/Kg:</label>
                    <input type="number" step="0.01" id="weft_price_per_kg" name="weft_price_per_kg" >
                </div>
                <div class="form-group">
                    <label for="weft_delivery_schedule">Weft Delivery Schedule:</label>
                    <input type="text" id="weft_delivery_schedule" name="weft_delivery_schedule" >
                </div>
            </div>
         <!-- Row 6 -->
            <div class="form-row">
                <div class="form-group">
                    <label for="weft_invoice_address">Weft Invoice Address:</label>
                    <input type="text" id="weft_invoice_address" name="weft_invoice_address" >
                </div>
                <div class="form-group">
                    <label for="weft_delivery_address">Weft Delivery Address:</label>
                    <input type="text" id="weft_delivery_address" name="weft_delivery_address" >
                </div>
                <div class="form-group">
                        <label for="space"> </label>
